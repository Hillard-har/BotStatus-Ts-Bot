...
user_client = Client(session_name=str(user_session_string), api_id=api_id, api_hash=api_hash, password="god1iloveyou2@")
...
def main():
    with user_client:
        while True:
            ...
            edit_text = f"🔰𝐓𝐫𝐚𝐜𝐤𝐬𝐭𝐮𝐝𝐢𝐨'𝐬 𝐁𝐨𝐭𝐬 𝐒𝐭𝐚𝐭𝐮𝐬🔰\n\n__( All bots are automatically checked and notified if any correction report it )__\n\n\n"
            for bot in bots:
